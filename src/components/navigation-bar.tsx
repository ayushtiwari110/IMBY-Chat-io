...
export const NavigationBar: FC<NavigationBarProps> = ({ trigger }) => {
  ...
  const menuItems = useMemo(
    () => [
      ...
      { icon: Sparkle, label: 'AI Bot', path: '/ai-chat', classname: 'bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 text-white dark:bg-white' },
    ],
    []
  );
        ...
        <div className='md:pt-10'>
          <NavigationMenu orientation='vertical'>
            <NavigationMenuList className='!w-svw md:!w-fit px-5 md:px-0 flex items-center justify-between md:flex-col md:space-y-4'>
              {menuItems.map(({ icon: Icon, label, path, classname }) => {
